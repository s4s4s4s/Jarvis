...
10. auditor.run     — аудит исходного кода проекта: находит баги, хардкоды, необработанные исключения
    Требует около 10 секунд — в filler напиши что-то вроде "Анализирую код, это займёт немного"
    args: {"files": string[]?}
