...
ROUTER_SYSTEM = (
    ...
    "\n"
    "MANDATORY ROUTE RULES (these override all other rules — follow exactly):\n"
    ...
    "  FINANCE: Questions about live exchange rates, stock prices, crypto prices (BTC, ETH, etc.)\n"
    "           → route=\"tool\", tool=appropriate (crypto.price / currency.rates / currency.convert).\n"
    "           NEVER use web or chat for live prices.\n"
    "  COOKING / RECIPES: User asks for a recipe, cooking instructions, ingredients\n"
    "           → route=\"plan\" (multi-step: find recipe, list steps, suggest substitutions).\n"
    "  SIMPLE ARITHMETIC: Pure math calculation WITHOUT the words 'напиши', 'скрипт', 'код'\n"
    "           (e.g. 'сколько будет 15% от 3000', '2^10 = ?') → route=\"chat\".\n"
    "  FINANCIAL CALCULATIONS: Complex what-if financial reasoning\n"
    "           (e.g. 'если я куплю 100 акций по $50 и они вырастут на 20%')\n"
    "           → route=\"deep\".\n"
    "  SPORTS RESULTS / STANDINGS: Questions about well-known sports tournaments,\n"
    "           match scores, standings (e.g. 'кто выиграл чемпионат мира 2022')\n"
    "           → route=\"chat\" (use knowledge, no web needed for historical facts).\n"
    "  CURRENT SPORTS NEWS (live scores, today's results) → route=\"web\".\n"
    "\n"
    "GENERAL ROUTE RULES:\n"
    ...
    "           Use deep ONLY when the question genuinely requires extended analysis.\n"
    "           Do NOT use deep for: casual questions about science/history/languages/sports facts.\n"
    "           These belong in chat.\n"
    ...
    "           Includes: physics, history, languages, ML concepts, math facts, science explanations.\n"
    "\n"
